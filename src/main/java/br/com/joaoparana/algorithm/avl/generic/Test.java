...
class Test {
	...
	/*
	 * @Test public void testRemove() { assertTrue(tree.isEmpty());
	 * 
	 * insert(16,24,36,19,44,28,61,74,83,64,52,65,86,93,88);
	 * assertTrue(tree.findMin() == 16); assertTrue(tree.findMax() == 93);
	 * 
	 * assertTrue(checkBalanceOfTree(tree.root));
	 * assertTrue(checkOrderingOfTree(tree.root));
	 * 
	 * tree.remove(88); assertTrue(checkBalanceOfTree(tree.root));
	 * assertTrue(checkOrderingOfTree(tree.root));
	 * assertFalse(tree.contains(88));
	 * 
	 * tree.remove(19); assertTrue(checkBalanceOfTree(tree.root));
	 * assertTrue(checkOrderingOfTree(tree.root));
	 * assertFalse(tree.contains(19));
	 * 
	 * tree.remove(16); assertTrue(checkBalanceOfTree(tree.root));
	 * assertTrue(checkOrderingOfTree(tree.root));
	 * assertFalse(tree.contains(16));
	 * 
	 * tree.remove(28); assertTrue(checkBalanceOfTree(tree.root));
	 * assertTrue(checkOrderingOfTree(tree.root));
	 * assertFalse(tree.contains(28));
	 * 
	 * tree.remove(24); assertTrue(checkBalanceOfTree(tree.root));
	 * assertTrue(checkOrderingOfTree(tree.root));
	 * assertFalse(tree.contains(24));
	 * 
	 * tree.remove(36); assertTrue(checkBalanceOfTree(tree.root));
	 * assertTrue(checkOrderingOfTree(tree.root));
	 * assertFalse(tree.contains(36));
	 * 
	 * tree.remove(52); assertTrue(checkBalanceOfTree(tree.root));
	 * assertTrue(checkOrderingOfTree(tree.root));
	 * assertFalse(tree.contains(52));
	 * 
	 * tree.remove(93); assertTrue(checkBalanceOfTree(tree.root));
	 * assertTrue(checkOrderingOfTree(tree.root));
	 * assertFalse(tree.contains(93));
	 * 
	 * tree.remove(86); assertTrue(checkBalanceOfTree(tree.root));
	 * assertTrue(checkOrderingOfTree(tree.root));
	 * assertFalse(tree.contains(86));
	 * 
	 * tree.remove(83); assertTrue(checkBalanceOfTree(tree.root));
	 * assertTrue(checkOrderingOfTree(tree.root));
	 * assertFalse(tree.contains(83)); } }
	 */
	/**
	 * Test method to perform a series of 100 unique insertions into a blank AVL
