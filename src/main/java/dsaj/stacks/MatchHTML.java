...
public class MatchHTML {
	...
	private final static String example = "" + "<body>" + "\n" + "<center>" + "\n" + "<h1> The Little Boat </h1>" + "\n"
	...
	/**
	 * Test the text given as standard input as html. If command line argument
	 * is given, preforms test on example from the book.
	 */
	public static void main(String[] args) {
		if (args.length == 0) {
			String input = new Scanner(System.in).useDelimiter("\\A").next(); // read
																				// entire
																				// input
																				// at
																				// once
