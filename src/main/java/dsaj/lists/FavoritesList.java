...
public class FavoritesList<E> {
	...
	PositionalList<Item<E>> list = new LinkedPositionalList<>(); // list of
																	// Items
	...
	/**
	 * Provides shorthand notation to retrieve count of item stored at Position
	 * p.
	 */
	...
	/**
	 * Returns an iterable collection of the k most frequently accessed
	 * elements.
	 */
