...
public class GraphExamples {
	...
	public static Graph<String, Integer> figure14_3() {
		String[][] edges = { { "BOS", "SFO" }, { "BOS", "JFK" }, { "BOS", "MIA" }, { "JFK", "BOS" }, { "JFK", "DFW" },
				{ "JFK", "MIA" }, { "JFK", "SFO" }, { "ORD", "DFW" }, { "ORD", "MIA" }, { "LAX", "ORD" },
				{ "DFW", "SFO" }, { "DFW", "ORD" }, { "DFW", "LAX" }, { "MIA", "DFW" }, { "MIA", "LAX" }, };
	...
	public static Graph<String, Integer> figure14_9() {
		String[][] edges = { { "A", "B" }, { "A", "E" }, { "A", "F" }, { "B", "C" }, { "B", "F" }, { "C", "D" },
				{ "C", "G" }, { "D", "G" }, { "D", "H" }, { "E", "F" }, { "E", "I" }, { "F", "I" }, { "G", "J" },
				{ "G", "K" }, { "G", "L" }, { "H", "L" }, { "I", "J" }, { "I", "M" }, { "I", "N" }, { "J", "K" },
				{ "K", "N" }, { "K", "O" }, { "L", "P" }, { "M", "N" }, };
	...
	public static Graph<String, Integer> figure14_11() {
		String[][] edges = { { "BOS", "JFK" }, { "BOS", "MIA" }, { "JFK", "BOS" }, { "JFK", "DFW" }, { "JFK", "MIA" },
				{ "JFK", "SFO" }, { "ORD", "DFW" }, { "LAX", "ORD" }, { "DFW", "SFO" }, { "DFW", "ORD" },
	...
	public static Graph<String, Integer> figure14_12() {
		String[][] edges = { { "A", "C" }, { "A", "D" }, { "B", "D" }, { "B", "F" }, { "C", "D" }, { "C", "E" },
	...
	public static Graph<String, Integer> figure14_14() {
		String[][] edges = { { "SFO", "LAX", "337" }, { "SFO", "BOS", "2704" }, { "SFO", "ORD", "1846" },
				{ "SFO", "DFW", "1464" }, { "LAX", "DFW", "1235" }, { "LAX", "MIA", "2342" }, { "DFW", "ORD", "802" },
				{ "DFW", "MIA", "1121" }, { "ORD", "BOS", "867" }, { "ORD", "JFK", "740" }, { "MIA", "JFK", "1090" },
	...
	public static Graph<String, Integer> figure14_15() {
		String[][] edges = { { "SFO", "LAX", "337" }, { "SFO", "BOS", "2704" }, { "SFO", "ORD", "1846" },
				{ "SFO", "DFW", "1464" }, { "LAX", "DFW", "1235" }, { "LAX", "MIA", "2342" }, { "DFW", "ORD", "802" },
				{ "DFW", "JFK", "1391" }, { "DFW", "MIA", "1121" }, { "ORD", "BOS", "867" }, { "ORD", "PVD", "849" },
				{ "ORD", "JFK", "740" }, { "ORD", "BWI", "621" }, { "MIA", "BWI", "946" }, { "MIA", "JFK", "1090" },
				{ "MIA", "BOS", "1258" }, { "BWI", "JFK", "184" }, { "JFK", "PVD", "144" }, { "JFK", "BOS", "187" }, };
		return graphFromEdgelist(edges, false);
	}
